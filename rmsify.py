...
rmsFunc = ''
rmsMain = 'main.c'
files = ['globals.c', 'zshared.c', 'intsstrings.c', 'dataLoadBackend.c', 'databases.c', 'voids.c', 'text.c', 'gamefunctions.c', 'setup.c', 'techstat.c', 'minerals.c', 'rain.c',
 'ending.c', 'singleplayer.c', 'drilling.c' , 'terrain.c', 'cinematic.c', 'bonus.c']
