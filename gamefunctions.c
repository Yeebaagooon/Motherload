...
void MainTitle(int x = 0, int z = 0){
	...
	BronzeNumber = a;
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,90,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,90,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,45,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,135,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	...
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,180,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	...
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,245,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	...
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,112,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,67,true);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	...
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,0", "Hoplite", 1,1,0,1,45,false);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,1", "Hoplite", 1,1,0,1,90,false);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	a = trGetNextUnitScenarioNameNumber();
	trArmyDispatch("0,2", "Hoplite", 1,1,0,1,90,false);
	xAddDatabaseBlock(dDestroyMe, true);
	xSetInt(dDestroyMe, xDestroyName, a);
	xSetInt(dDestroyMe, xDestroyTime, trTimeMS()+GoldTime);
	trTechInvokeGodPower(0, "Bronze XP05", vector(16, 3, 16), vector(0,0,0));
	UnitCreate(0, "Hoplite",0,0,90);
